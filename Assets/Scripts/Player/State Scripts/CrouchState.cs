...
public class CrouchState : State<PlayerController> //makes this state only available to PlayerController
{
    ...
    public override void ChangeState()
    {
        ...
        if (_groundCheck.Check() && _crouch) //if character is grounded and presses coruch they uncrouch
        {
